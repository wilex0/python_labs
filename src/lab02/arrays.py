...
#unique_sorted
print(f"unique_sorted:\n[3, 1, 2, 1, 3] -> %s\n[] -> %s\n[-1, -1, 0, 2, 2] -> %s\n[1.0, 1, 2.5, 2.5, 0] -> %s" % (unique_sorted([3, 1, 2, 1, 3]), unique_sorted([]), unique_sorted([-1, -1, 0, 2, 2]), unique_sorted([1.0, 1, 2.5, 2.5, 0])))

#flatten
print(f"flatten:\n[[1, 2], [3, 4]] -> %s\n([1, 2], (3, 4, 5)) -> %s\n[[1], [], [2, 3]] -> %s" % (flatten([[1, 2], [3, 4]]), flatten(([1, 2], (3, 4, 5))), flatten([[1], [], [2, 3]])))
try:
    flatten([[1, 2], "ab"])
except ValueError:
