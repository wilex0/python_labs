...
![test_text](python/images/lab07/test_text.png)

## Тесты для конвертации
![test_json_csv](python/images/lab07/test_json_csv_1.png)
![test_json_csv](python/images/lab07/test_json_csv_2.png)

## Проект отформатирован с помощью black
![black](python/images/lab07/black.png)

## Покрытие кода:
![cover](python/images/lab07/cover.png)
...
![model](python/images/lab08/models.png)
...
![students](python/images/lab08/serialize.png)
...
****
### class SingleLinkedList - коллекция, основанная на связанных последовательно элементах Node, который хранят в себе указатель на следующий элемент коллекции и значение текущего Node
### Оснвоные операции:
...
![p1](python/images/lab10/t_p1.png)
![p1](python/images/lab10/t_p2.png)
![bench](python/images/lab10/bench.png)
